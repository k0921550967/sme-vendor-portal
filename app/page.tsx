    ...
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-700 to-brand-900">
      <div className="bg-white rounded-2xl shadow-2xl p-10 w-full max-w-md flex flex-col items-center gap-6">
        ...
        >
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-3 px-6 py-3 rounded-lg border border-gray-300 bg-white hover:bg-gray-50 transition-colors shadow-sm text-gray-700 font-medium cursor-pointer"
          >
